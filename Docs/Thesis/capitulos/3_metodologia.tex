...
Em \texttt{RUN\_OPEN}, a frequência elétrica incrementar-se-ia linearmente até $300\,\text{Hz}$; as correntes de fase apresentariam o padrão trapezoidal característico da comutação de seis passos (pulsos de $120°$ elétricos, intervalo Hi-Z de $60°$). A transição para \texttt{RUN\_SPEED} ocorreria quando a velocidade estimada superasse 600\,RPM por 200\,ms consecutivos.
