...
\begin{table}[h]
\centering
\caption{Cronograma atualizado de atividades do projeto.}
\label{Cronograma proposto de atividades.}
\resizebox{\linewidth}{!}{%
\begin{tabular}{|c|l|c|c|c|c|c|} 
\cline{3-7}
\multicolumn{1}{c}{} & \multicolumn{1}{c|}{} & \multicolumn{5}{c|}{\textbf{Mês (2026)}} \\ 
\cline{3-7}
\multicolumn{1}{l}{} &  & 02 & 03 & 04 & 05 & 06 \\ 
\hline
\multirow{7}{*}{\textbf{Atividades}} & Simulação do Circuito & {\cellcolor[rgb]{0.753,0.753,0.753}} & {\cellcolor[rgb]{0.753,0.753,0.753}} &  &  &  \\ 
\hhline{|~------|}
 & Projeto da Placa (PCB) e Compras & {\cellcolor[rgb]{0.753,0.753,0.753}} & {\cellcolor[rgb]{0.753,0.753,0.753}} &  &  &  \\ 
\hhline{|~------|}
 & Prototipagem e Soldagem &  & {\cellcolor[rgb]{0.753,0.753,0.753}} & {\cellcolor[rgb]{0.753,0.753,0.753}} &  &  \\ 
\hhline{|~------|}
 & Testes Iniciais (Sinais e PWM) &  &  & {\cellcolor[rgb]{0.753,0.753,0.753}} & {\cellcolor[rgb]{0.753,0.753,0.753}} &  \\ 
\hhline{|~------|}
 & Correções e Ajustes Físicos &  &  &  & {\cellcolor[rgb]{0.753,0.753,0.753}} &  \\ 
\hhline{|~------|}
 & Testes de Carga com o Motor &  &  &  & {\cellcolor[rgb]{0.753,0.753,0.753}} & {\cellcolor[rgb]{0.753,0.753,0.753}} \\ 
\hhline{|~------|}
 & Escrita do Texto e Defesa &  &  &  & {\cellcolor[rgb]{0.753,0.753,0.753}} & {\cellcolor[rgb]{0.753,0.753,0.753}} \\
\hline
\end{tabular}
}
